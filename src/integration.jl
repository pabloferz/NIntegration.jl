...
@inline function _apply_rule{F}(f::F, r::Region{3})
    x₁, x₂, x₃ = r.x
    h₁, h₂, h₃ = r.h
    ...
    for i = 1:length(ζ)
        ...
        (vh₁, vh₂, vh₃) = (v * h₁, v * h₂, v * h₃)
        (y₁⁻, y₂⁻, y₃⁻) = (x₁ - vh₁, x₂ - vh₂, x₃ - vh₃)
        (y₁⁺, y₂⁺, y₃⁺) = (x₁ + vh₁, x₂ + vh₂, x₃ + vh₃)

        y = f(x₁⁺, x₂⁺, y₃⁺) + f(x₁⁺, y₂⁺, x₃⁺) + f(y₁⁺, x₂⁺, x₃⁺) +
            f(x₁⁺, x₂⁺, y₃⁻) + f(x₁⁺, y₂⁺, x₃⁻) + f(y₁⁺, x₂⁺, x₃⁻) +
            f(x₁⁺, x₂⁻, y₃⁺) + f(x₁⁺, y₂⁻, x₃⁺) + f(y₁⁺, x₂⁻, x₃⁺) +
            f(x₁⁺, x₂⁻, y₃⁻) + f(x₁⁺, y₂⁻, x₃⁻) + f(y₁⁺, x₂⁻, x₃⁻) +
            f(x₁⁻, x₂⁺, y₃⁺) + f(x₁⁻, y₂⁺, x₃⁺) + f(y₁⁻, x₂⁺, x₃⁺) +
            f(x₁⁻, x₂⁺, y₃⁻) + f(x₁⁻, y₂⁺, x₃⁻) + f(y₁⁻, x₂⁺, x₃⁻) +
...
function apply_rule{F}(f::F, r::Region{3})
    x₁, x₂, x₃ = r.x
    h₁, h₂, h₃ = r.h
